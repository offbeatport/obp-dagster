...
def get_cluster_representatives(
    ...
    """
    representatives = select_representatives(items_df, embeddings_array, k=k)
    ...
    # Get short cleaned snippets (first 200 chars of clean_body)
    ...
    for _, row in representatives.iterrows():
        ...
        snippet = clean_body_text[:200].strip()
        if snippet:
            snippets.append(snippet)
    
    snippets_str = " | ".join(snippets[:3])  # Top 3 snippets
