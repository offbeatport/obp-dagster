...
class PocketBaseResource(ConfigurableResource):
    ...
    def _client(self) -> PocketBaseClient:
        """Get or create a PocketBaseClient instance."""
    ...
    def get_one_by_filter(self, collection: str, filter_expr: str) -> Optional[Dict[str, Any]]:
        """Delegate to client."""
        return self._client().get_one_by_filter(collection, filter_expr)

    def create(self, collection: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Delegate to client."""
        return self._client().create(collection, payload)

    def update(self, collection: str, record_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Delegate to client."""
        return self._client().update(collection, record_id, payload)

    def upsert_ing_item(self, item: Dict[str, Any]) -> Tuple[str, str]:
        """Delegate to client."""
        return self._client().upsert_ing_item(item)
